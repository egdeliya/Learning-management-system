...
class AdminServiceAddStudentTest extends FlatSpec
  ...
  "Admin.AdminService" should "add student successfully" in new init {
  ...
  "Admin.AdminService" should "fail adding student to fake group" in new init {
    val fakeGroup = "fake"
  ...
  "Admin.AdminService" should "fail adding student with negative entry year" in new init {
  ...
  "Admin.AdminService" should "fail adding student with wrong degree" in new init {
  ...
  "Admin.AdminService" should "fail adding student with wrong form" in new init {
  ...
  "Admin.AdminService" should "fail adding student with wrong basis" in new init {
