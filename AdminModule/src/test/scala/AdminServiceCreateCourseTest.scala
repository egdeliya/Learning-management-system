...
class AdminServiceCreateCourseTest extends FlatSpec
  ...
  "AdminService" should "create course successfully" in new init {
  ...
  "AdminService" should "fail creating course with empty name" in new init {
    val result = Future.sequence(courses.map { course =>
  ...
  "AdminService" should "fail creating course with empty description" in new init {
    val result = Future.sequence(courses.map { course =>
